...
- OWNER_OBSERVED_P5.6_UX_GAP: Functional owner/browser testing passed, but the required save-at-zero step before a new Product or newly added choice can receive stock is too cumbersome for the intended modern assistant-style experience. P5.6A owns the approved correction before Phase 5 UX closure and must retain persisted choice identity, server-owned quantity, and the immutable adjustment trail.
