...
- Status: IN_PROGRESS; P6.7a through P6.7c are CLOSED, and P6.7d is NOT_STARTED.
...
- Status: CLOSED; released and exact-SHA CI-passed after local implementation, audit verification, and required owner/browser verification. Delivery metadata remains Git/GitHub authority.
