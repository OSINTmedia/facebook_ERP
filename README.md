...
- Backend inventory foundations compute Product availability and define immutable Business/choice/actor-scoped adjustment facts. Inventory mutations do not create those records yet, and stock controls, availability UI consumers, and full workspace behavior have not started.
